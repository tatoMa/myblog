            ...
            <v-list class="transparent">
              <v-list-tile>
                ...
                <v-list-tile-sub-title>
                  <a
                    href="mailto:james.dev1904@gmail.com"
                    style="text-decoration: none"
                  >JAMES.DEV1904@GMAIL.COM</a>
                </v-list-tile-sub-title>
              </v-list-tile>
              <v-list-tile>
                <v-list-tile-avatar color="primary">
                ...
                <v-list-tile-sub-title>MELBOURNE</v-list-tile-sub-title>
              </v-list-tile>
              <v-list-tile>
                <v-list-tile-avatar color="primary">
                  <v-icon
                ...
                <v-list-tile-sub-title>0451-667-676</v-list-tile-sub-title>
              </v-list-tile>
            </v-list>
          </v-flex>
        </v-layout>
